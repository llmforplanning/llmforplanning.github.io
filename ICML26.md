...
<table class="schedule-table">
  ...
  <tbody>
    <!-- Opening -->
    <tr class="session-group opening">
      <td>08:00–08:10</td>
    ...
    <!-- Poster Session -->
    <tr class="session-group poster-session">
      <td>15:30–16:30</td>
      <td>Poster Session including all accepted works</td>
    </tr>
    
    <!-- Closing -->
    <tr class="session-group closing">
      <td>16:30–17:00</td>
      <td>Round Table + Closing Remarks</td>
    </tr>
  </tbody>
</table>
 ...
 * Michael Katz [contact](mailto:michael.katz1@ibm.com), IBM Research 
 * Augusto B. Corrêa [contact](mailto:augusto.blaascorrea@chch.ox.ac.uk), University of Oxford
